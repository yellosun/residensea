...
export const metadata: Metadata = {
  ...
  description:
    "Applications for the May 2027 Galveston, Texas artist residency are opening soon.",
};
  ...
  return (
    <div className="px-6 py-24">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg font-medium text-sea">May 2027 · 7–10 days</p>
        <p className="mx-auto mt-6 max-w-lg text-base leading-7 text-ink/80">
          Our next residency takes us to the Texas Gulf Coast. We&apos;re still
          finalizing dates, partners, and the application itself — but if
